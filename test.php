            ...
            <span class="navbar-text">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle global_button" type="button"
                    ...
                    <div class="uupload">
                        <span>
                            <form action="code.php" method="post" enctype="multipart/form-data">
                                ...
                                <button style="font-size: 110%; margin-left:0%;" type="submit" name="submit">Upload
                                    File</button>
                            </form>
                        </span>
                        <div id="message"></div>
                    ...
                    <li class="nav-item">
                        <form action="code.php" method="POST">
                            <button style="margin-right: 18px;" type="submit" name="userLogout"
...
<body class="bodystyle">
  ...
  <img src="<?= $results['Job_Image']; ?>" class="card-img-top" alt="<?= $results['Job_Title']; ?>">
                                ...
                                <div class="card-hover" style="height: 0px; overflow: hidden; transition: height 0.3s ease;">
                                    <div class="card-body">
                                        <p class="card-text">
                                            <?= $results['Location']; ?>
                                        </p>
    ...
    <script>
        // Show job details and apply button on hover
        $('.job-card').hover(function () {
            $(this).find('.job-card-details').removeClass('d-none');
            $(this).find('.btn').removeClass('d-none');
        }, function () {
            $(this).find('.job-card-details').addClass('d-none');
