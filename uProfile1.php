...
<nav <?php ugetNavMode() ?>>
        ...
        <img style="margin-right:2%;" src="./img/logo.png" alt="">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            ...
            <input type="hidden" name="umodechange" value="uProfile1.php">
    ...
    <div class="container1">
        <div class="left-nav1">
          <div class="nav-item1">
            ...
            <a href="uProfile1.php"><span><h5 class="match">My Account</h5></span></a>
          </div>
          <div class="nav-item1">
            <i class="fas fa-shield-alt"></i>
            <a href="uSecurity.php"><span><h5 class="match">Security</h5></span></a>
          </div>
          <div class="nav-item1">
            <i class="fas fa-bell"></i>
            <a href="uNotif.php"><span><h5 class="match">Notifications</h5></span></a>
          </div>
         
          <div class="nav-item1">
            <i class="fas fa-headset"></i>
            <a href="uApplied.php"><span><h5 class="match">Applied Jobs</h5></span></a>
          </div>

          <div class="nav-item1">
            <i class="fas fa-headset"></i>
            <a href="uApplied.php"><span><h5 class="match">Download Resume</h5></span></a>
          </div>
