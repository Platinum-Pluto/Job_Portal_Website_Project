...
<body>
  ...
  <div class="container">
    ...
    <form action="code.php" method="POST" enctype="multipart/form-data">
      ...
      <button style="margin-left: 48%;padding-left:3%;padding-right:3%; font-size:larger" type="submit" name="add_job"
...
<script>
  document.getElementById('jobPhotoInput').addEventListener('change', function (event) {
    var input = event.target;
    var reader = new FileReader();
    reader.onload = function () {
      var photoBox = document.querySelector('.photo-upload-box');
      photoBox.style.backgroundImage = 'url(' + reader.result + ')';
      photoBox.querySelector('.empty-text').style.display = 'none';
    };
