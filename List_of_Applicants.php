...
<body>
                        ...
                        <tr>
                          <td>
                            <a href="#" data-toggle="modal"
                              data-target="#applicantModal<?php echo $applicant['User_ID']; ?>"><?php echo $applicant['User_Name']; ?></a>
                          </td>
                          <td>
                            <?= $applicant['Email']; ?>
                          </td>
                          ...
                          <td>
                            <div class="btn-group" role="group">
                              <form action="code.php" method="POST" class="d-inline">
                                <button type="submit" name="accept" value="<?= $applicant['Job_ID'] . '|' . $applicant['Email']; ?>"
                                  class="btn btn-success">Accept</button>
                                <button type="submit" name="reject" value="<?= $applicant['Job_ID'] . '|' . $applicant['Email']; ?>"
  ...
  <div class="modal fade" id="applicantModal<?php echo $applicant['User_ID']; ?>" tabindex="-1" role="dialog"
